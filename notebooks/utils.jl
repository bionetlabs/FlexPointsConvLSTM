...
# ╔═╡ a4e6c09a-f680-41cf-a48a-abb6ccac4e37
begin
	using Images
	using FileIO
end

# ╔═╡ de5be9d0-0a37-11f0-317f-f953303be285
begin
	projectdir = dirname(Base.current_project())
	imgdir = joinpath(projectdir, "img")

	fig1 = img1 = load(joinpath(imgdir, "Fig1.png"))
	fig1vt = img1 = load(joinpath(imgdir, "Fig1_(VT.png"))
	fig1bii = img1 = load(joinpath(imgdir, "Fig1_(BII.png"))
	fig1afib = img1 = load(joinpath(imgdir, "Fig1_(AFIB.png"))
	fig1b = img1 = load(joinpath(imgdir, "Fig1_(B.png"))
	fig1t = img1 = load(joinpath(imgdir, "Fig1_(T.png"))
	
	merged = vcat(fig1, fig1vt)
	merged = vcat(merged, fig1bii)
	merged = vcat(merged, fig1afib)
	merged = vcat(merged, fig1b)
	merged = vcat(merged, fig1t)
	
	save(joinpath(imgdir, "Fig1merged.png"), merged)
end
...
manifest_format = "2.0"
project_hash = "55c0b08c72637f354e2e0b4eaa1ee21bdd448d47"
